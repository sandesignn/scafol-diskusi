...
<body>
    ...
    <div class="mymain-container">
        ...
        <div class="kotak_login">
            <p class="tulisan_login">Login <br><b>Akun Scafol</b></p>
            ...
            <form action="<?= base_url('auth'); ?>" method="post">
                ...
                <br>
                <input type="text" name="username" class="form_login" placeholder="sandixxxx">

                <label class="form_name"><b>Password</b></label>
                <input type="password" name="password" class="form_login" placeholder="password...">

                <input type="submit" name="btn-go" class="tombol_login form_name" value="Signin">

                <br />
                <p class="form_name">Belum punya akun?<a class="link" href="<?= base_url() ?>auth/register"><b> Daftar Sekarang</b></a></p>
